...
class FacilityController extends Controller
{
    public function index(Request $request): View
    {
        ...
        $facilities = Facility::query()
            ...
            ->when($status === 'unverified', fn (Builder $builder) => $builder->contactReviewOpen())
            ...
            ->when($email === 'without', fn (Builder $builder) => $builder
                ->where(fn (Builder $missing) => $missing->whereNull('email')->orWhere('email', ''))
                ->where('official_email_absent', false))
            ...
            ->when($website === 'without', fn (Builder $builder) => $builder
                ->where(fn (Builder $missing) => $missing->whereNull('website')->orWhere('website', ''))
                ->where('official_website_absent', false))
