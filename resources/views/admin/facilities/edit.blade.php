    ...
    <main class="container admin-main">
        ...
        <form class="admin-form" method="post" action="{{ route('admin.facilities.update', $facility) }}">
            ...
            <div class="admin-form__grid">
                ...
                <div class="admin-field admin-field--wide admin-contact-field--wide admin-contact-website-field"><label for="website">Website</label><input id="website" name="website" type="url" value="{{ old('website', $facility->website) }}" placeholder="https://..."><label class="admin-contact-absent"><input name="official_website_absent" type="hidden" value="0"><input id="official_website_absent" name="official_website_absent" type="checkbox" value="1" @checked(old('official_website_absent', $facility->official_website_absent ?? false))> Kein offizieller Internetauftritt gefunden</label>@include('admin.facilities._field-message', ['field' => 'website', 'helper' => 'Aktivieren, wenn nach manueller Prüfung keine offizielle Website oder Einrichtungsseite gefunden wurde.'])</div>
