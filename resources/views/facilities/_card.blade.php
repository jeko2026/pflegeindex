...
<article class="result-card">
    ...
    @if ($cardPhone)
        <p class="phone-line">
            ...
            <a class="phone-link" href="tel:{{ $cardPhone }}">{{ $facility->formattedPhone() }}</a>
        </p>
    @else
    ...
    <div class="result-card__footer">
        ...
        <div class="result-card__actions">
            @if($cardWebsite)
                <a class="card-action-btn" href="{{ $cardWebsite }}" target="_blank" rel="noopener" aria-label="Website von {{ $facility->name }} öffnen">
            ...
            @endif
            @if($cardEmail)
                <a class="card-action-btn" href="mailto:{{ $cardEmail }}" aria-label="E-Mail an {{ $facility->name }}">
